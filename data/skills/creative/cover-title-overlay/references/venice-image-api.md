...
## Current Model (September 2026)
**`grok-imagine-image-quality`** — the active primary image generation model for extreme photorealism, dynamic lighting, and dark nightride aesthetics.

### Alternative / Fallback Models
- `flux-2-max` — secondary baseline model.
- `recraft-v4-pro` — vector/graphic design & brutalist poster art.
- `nano-banana-pro` — hyper-fine optical lens & micro-textures.

### Deprecated Models (404 Not Found)
- `ideogram-v4`
- `flux-dev`
